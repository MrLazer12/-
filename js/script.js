...
function setBorder(IDelement){
    ...
    IDelement.style.border = "2px solid #FA573C";
}
function unSetBorder(IDelement){
    IDelement = document.getElementById(IDelement);
    IDelement.style.borderRadius = "0";
    IDelement.style.border = "none";
}
...
function visa_change_animate(){
    var visa_img = document.getElementById("visa_img");
}
...
function cw_write(){
    ...
    input_cw.value  = card_number.value;
}
